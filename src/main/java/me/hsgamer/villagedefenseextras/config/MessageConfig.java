...
public class MessageConfig extends PathableConfig {
    ...
    public static final StringConfigPath KIT_DEFUSER_NAME = new StringConfigPath("kit.defuser.name", "&cDefuser");
    public static final StringConfigPath KIT_DEFUSER_DESCRIPTION = new StringConfigPath("kit.defuser.description", "&7You defuse any bomb you interact");
    public static final StringConfigPath KIT_DEFUSER_ITEM_NAME = new StringConfigPath("kit.defuser.item-name", "&eDefuser");
    public static final StringConfigPath KIT_DEFUSER_ITEM_LORE = new StringConfigPath("kit.defuser.item-lore", "&7Right-click on a bomb to defuse it");
